...
namespace Ksu.Cis300.NameLookup.Tests
{
    ...
    public class DictionaryTests
    {
        ...
        {
            Type type = new DictionaryLibrary.Dictionary<string, int>().GetType();
            // The Dictionary must have a Count property with a set accessor; hence, 
            // both GetProperty and SetMethod should be non-null.
        ...
        {
            DictionaryLibrary.Dictionary<string, int> d = new();
            Assert.That(d, Has.Count.EqualTo(0));
        }
        ...
        {
            DictionaryLibrary.Dictionary<int, double> d = new();
            d.Add(17, 32);
        ...
        public void TestDAddThreeLookUpAll()
        {
            ...
            HashTableTester k2 = new(725);
            HashTableTester k3 = new(745);
            d.Add(k1, 1);
            d.Add(k2, 2);
            d.Add(k3, 3);
            List<int> list = new();
        ...
        {
            DictionaryLibrary.Dictionary<HashTableTester, int> d = new();
            HashTableTester k1 = new(100);
            HashTableTester k2 = new(125, true);
            d.Add(k1, 7);
        ...
        public void TestHRehashToSameList()
        {
            ...
            for (int i = 50; i < 116; i += 11)
            {
                d.TryGetValue(new HashTableTester(i), out int v);
                retrieved.Add(v);
            }
            Assert.That(retrieved, Is.Ordered.And.EquivalentTo(elements));
        }
