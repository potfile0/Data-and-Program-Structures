...
namespace Ksu.Cis300.NameLookup.Tests
{
    ...
    public class DictionaryTests
    {
        ...
        public void TestALookUpEmpty()
        {
            ...
            Assert.That(() => d["abc"], Throws.InstanceOf<KeyNotFoundException>());
        }
        ...
        public void TestDTwoInstancesSameLocation()
        {
            ...
            HashTableTester k2 = new(105, true);
            d[k1] = 7;
        ...
        public void TestIForeachEmpty()
        {
            ...
            List<KeyValuePair<string, double>> list = new();
        ...
        public void TestJForeachNonempty()
        {
            ...
            List<KeyValuePair<HashTableTester, int>> list = new();
        ...
        public void TestKForeachNonemptyKeys()
        {
            ...
            List<HashTableTester> keys = new();
            foreach (KeyValuePair<HashTableTester, int> p in pairs)
            {
                d.Add(p.Key, p.Value);
                keys.Add(p.Key);
            }
            List<HashTableTester> list = new();
