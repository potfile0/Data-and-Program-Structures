...
namespace Ksu.Cis300.Graphs.Tests
{
    ...
    public class DirectedGraphTests
    {
        ...
        public void TestANodeCountNoSet()
        {
            ...
            // We will ignore the warning and allow a NullReferenceException to be thrown if
            // NodeCount isn't implemented.
        ...
        {
            DirectedGraph<string, string> g = new();
        ...
        {
            DirectedGraph<int, string> g = new();
        ...
        /// <summary>
        /// Tests that adding a duplicate node throws the correct exception.
        /// </summary>
        [Test, Timeout(1000)]
        public void TestBAddDuplicateNodes()
        {
            DirectedGraph<int, string> g = new();
            g.AddNode(2);
            g.AddNode(3);
            g.AddNode(5);
            Assert.That(() => g.AddNode(3), Throws.InstanceOf<ArgumentException>());
        }
        ...
        public void TestCAddNullSource()
        {
            ...
            Assert.Multiple(() =>
            {
                // We'll override the compiler warning so that we can test that the 
                // ArgumentNullException is thrown.
                Assert.That(() => g.AddEdge(null!, "c", 3), Throws.InstanceOf<ArgumentNullException>());
        ...
        {
            DirectedGraph<int, int> g = new();
            g.AddEdge(1, 2, 10);
            Assert.Multiple(() =>
            {
                Assert.That(() => g.AddEdge(3, 3, 3), Throws.InstanceOf<ArgumentException>());
        ...
        /// <summary>
        /// Tests that we can iterate through the outgoing edges when there is a single outgoing
        /// edge.
        /// </summary>
        [Test, Timeout(1000)]
        ...
        public void TestEAddNullDestination()
        {
            ...
            Assert.Multiple(() =>
            {
                // We'll override the warning so that we can test that an ArgumentNullException
                // is thrown.
                Assert.That(() => g.AddEdge("a", null!, 3), Throws.InstanceOf<ArgumentNullException>());
        ...
        public void TestEAddDuplicateEdge()
        {
            ...
            Assert.Multiple(() =>
            {
                Assert.That(() => g.AddEdge(1, 2, "b"), Throws.InstanceOf<ArgumentException>());
