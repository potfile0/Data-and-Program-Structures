...
namespace Ksu.Cis300.SortLibrary.Tests
{
    ...
    {
        /// <summary>
        /// Tests that when null is passed to MergeSort, the proper exception is thrown.
        /// </summary>
        [Test, Timeout(1000)]
        public void TestASortNull()
        {
            // We override the warning in order to test that this case is handled properly.
            Assert.That(() => Sort.MergeSort(null!), Throws.InstanceOf<ArgumentNullException>());
        }
