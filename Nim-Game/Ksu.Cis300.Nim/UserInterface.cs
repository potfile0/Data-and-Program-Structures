...
{
    /// <summary>
    /// A GUI for a program to play a variant of Nim.
    /// </summary>
    public partial class UserInterface : Form
    {
        ...
        /// </summary>
        private readonly string[] _pileNames = { "Pile 1", "Pile 2", "Pile 3" };
        ...
        /// <summary>
        /// The current board position. We'll initialize it to a meaningless position to
        /// avoid warnings about nulls.
        /// </summary>
        ...
        /// <param name="sender">The object signaling the event.</param>
        /// <param name="e">Information about the event.</param>
        private void RemovePileSelectedIndexChanged(object sender, EventArgs e)
        {
